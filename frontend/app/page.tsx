...
export const metadata: Metadata = {
  title: 'LeadFlow — Modern CRM for Sales Teams',
  description:
    'LeadFlow brings leads, deals, pipeline management, sales analytics and AI-powered sales intelligence into one focused CRM workspace.',
  keywords: [
    'CRM',
    'B2B CRM',
    'Sales Pipeline',
