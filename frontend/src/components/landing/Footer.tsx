      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 pb-12 border-b border-border-light dark:border-border-dark">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-text-secondary-light dark:text-text-secondary-dark">
              <li>
                <Link to="/login" className="hover:text-copper-600 dark:hover:text-copper-400 transition-colors">
                  Sign In to CRM
                </Link>
              </li>
              <li>
                <Link to="/setup" className="hover:text-copper-600 dark:hover:text-copper-400 transition-colors">
                  Organization Setup
                </Link>
              </li>
              <li className="pt-2">
